...
@section('content')
    ...
    @include('pharmacy.header-search')
    <div class="container" id="listClinics">
        <div class="clinics-list">
            <div class="clinics-header row">
                <div class=" d-flex justify-content-between">
                    <span class="fs-24px text-phong-mall" style="font-weight: 800">Hiệu thuốc gần bạn</span>
                </div>
            </div>
            <p style="color: red;text-align: center;margin:30px 0;display: none" class="text-not-address w-100">Không có hiệu thuốc nào như bạn cần tìm quanh bạn</p>

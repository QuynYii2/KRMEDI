...
<div class="background-image_Clinics mb-3 d-none d-sm-flex">
    <div class="container">
        <div class=" justify-content-center align-items-center mb-3 d-none d-sm-flex">
            <div class="title-list-clinic">Hiệu thuốc gần bạn</div>
        </div>
...
<script>
    ...
    async function searchClinics() {
        // loadingMasterPage();
        let urlSearch = `{{ route('pharmacy.search') }}`;

                        ...
                        <div class="prescription-group d-flex align-items-center">
                            <div class="row w-100">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control medicine_name " value="{{$pro['medicine_name']}}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="medicine_ingredients">Medicine Ingredients</label>
                                    <input type="text" class="form-control medicine_ingredients " value="{{$pro['medicine_ingredients']}}">
                                </div>
                                <div class="form-group">
                                    <label for="quantity">{{ __('home.Quantity') }}</label>
                                    <input type="number" min="1" class="form-control quantity" value="{{$pro['quantity']}}" readonly>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" class="form-control treatment_days" readonly value="{{$pro['treatment_days']}}">
                                </div>
                            </div>
                        </div>
                    </div>

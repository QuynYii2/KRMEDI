...
@section('main-content')
    ...
    <div class="container-fluid">
        ...
        <form id="form" action="{{ route('api.backend.booking.store') }}" method="post"
            ...
            @csrf
            <div class="row">
                <input type="text" class="form-control" name="type" value="{{$bookings_edit->type}}" hidden>
                <div class="col-md-3 form-group">
                    <label for="user">{{ __('home.Tên người đăng ký') }}</label>
                    <input type="text" class="form-control" name="user_id" value="{{@$bookings_edit->user_id}}" hidden>
                    <input type="text" class="form-control" value="{{@$userName}}" disabled>
                </div>
                <div class="col-md-3 form-group">
                    <label for="clinic_id">{{ __('home.BusinessName') }}</label>
                    <input type="text" class="form-control" name="clinic_id" value="{{@$bookings_edit->clinic_id}}"
                           hidden>
                    <input type="text" class="form-control" value="{{@$clinicName}}" disabled>
                </div>
                <div class="col-md-3 form-group">
                    ...
                    @if ($userData->member == "DOCTORS")
                        <input type="text" class="form-control" name="department_id" value="{{$userData->department_id}}" hidden>
                        <input type="text" class="form-control" value="{{$userData->specialty}}" disabled>
                    @else
                        ...
                        <div class="d-flex align-items-center row" data-repeater-item>
                            ...
                            <div class="col-md-3 firstSelector">
                                <div class="form-group">
                                    <label for="selectType">Loại khám bệnh:</label>

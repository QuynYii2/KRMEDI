                                    ...
                                    <div class="frame component-medicine w-100">
                                        ...
                                        <div class="div">
                                            <div class="div-2">
                                                ...
                                                <div class="flex-wrap d-flex" style="column-gap: 5px; align-items: center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 21 21" fill="none">
                                                        ...
                                                        <defs>
                                                            <clipPath id="clip0_5506_14919">
                                                                <rect width="20" height="20" fill="white" transform="translate(0.5 0.933594)"></rect>
                                                            </clipPath>
                                                        </defs>
                                                    </svg>
                                                    <div class="text-wrapper-3">${medicine.detail_address}</div>
                                                </div>
                                            </div>

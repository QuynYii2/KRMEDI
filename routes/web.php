...
//    Route::get('/update-user-online', [AuthController::class, 'updateUserOnline'])->name('update-user-online');
    ...
    Route::group(['prefix' => 'questions'], function () {
        ...
        Route::get('/new-list/{user_id}/{id}', [BackendQuestionController::class, 'getNewListQuestion'])->name('questions.new-list.filter');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::group(['prefix' => 'connect'], function () {
        ...
        Route::group(['prefix' => 'chat'], function () {
            ...
            Route::get('show', [ConnectChatMessageController::class, 'show'])->name('api.backend.connect.chat.show');
